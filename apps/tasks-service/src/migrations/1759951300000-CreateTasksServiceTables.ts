...
export class CreateTasksServiceTables1759951300000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Create Assignees table if it doesn't exist
        ...
        // Create indexes for Tasks table (only if they don't exist)
        ...
        // Create indexes for Assignees table (only if they don't exist)
        ...
        // Create indexes for Task History table (only if they don't exist)
